...
curl --location --request GET http://3.7.120.206:8081/api/memes/


# Execute the POST /memes endpoint using curl

curl --location --request POST http://3.7.120.206:8081/api/memes/ --header 'Content-Type: application/json' --data-raw '{
"name": "MS Dhoni", "url": "https://images.unsplash.com/photo-1593766827228-8737b4534aa6ixid=MXwxMjA3fDB8MHxzZWFyY2h8OXx8Y3JpY2tldHxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60", "caption": "Cricket pic from Dhoni"
}'
